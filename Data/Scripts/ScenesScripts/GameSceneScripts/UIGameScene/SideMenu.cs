		...
		if (target != null) 
		{
			...
			if (target == player || (target != player && player.wisdomModifier >= -1))
			{
				...
				if (target.directMove == true && target.diagonalMove == false)
				{
					...
					MoveFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/MovementsFrames/DirectMovementFrame.png");
				}
				else if (target.directMove == false && target.diagonalMove == true)
				{
					MoveFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/MovementsFrames/DiagonalMovementFrame.png");
				}
				else if (target.directMove == true && target.diagonalMove == true)
				{
					MoveFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/MovementsFrames/AlloutMovementsFrame.png");
				}

				// Картинка направления атаки
				if (target.weapon.directAttack == true && target.weapon.diagonalAttack == false)
				{
					AttackFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/AttackFrames/DirectAttackFrame.png");
				}
				else if (target.weapon.directAttack == false && target.weapon.diagonalAttack == true)
				{
					AttackFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/AttackFrames/DiagonalAttackFrame.png");
				}
				else if (target.weapon.directAttack == true && target.weapon.diagonalAttack == true)
				{
					AttackFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/AttackFrames/AlloutAttackFrame.png");
				}
			}
			else
			{
				MoveFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/QuestionMarkFrame/QuestionMarkFrame.png");
				AttackFrame.Texture = (Texture2D)GD.Load("res://Data/Scenes/GameScene/UIGameScene/SideMenu/Frames/QuestionMarkFrame/QuestionMarkFrame.png");
			}
