...
public partial class FieldCoordinate : Node
{
	...
	public static int xFieldSize = 50; //Размер ширины игрового поля, начало отсчета с 0
	public static int yFieldSize = 50; //Размер высоты игрового поля, начало отсчета с 0
